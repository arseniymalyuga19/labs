...
int main() {
    ...
    n1 = (n2 + n3 - n1) + n1; // результат в base 16
    n1.SwitchBase(2);
    n1.Print();
    ...
    Number n4 = 12345; // base 10
    n1 = 255; // n1 = 255 -> "255"
    n1.SwitchBase(2); // -> "11111111"
    n4 += n1;
    n4.Print();

    n4 = "13579"; // остаётся в base 10
    n4.Print();

    --n4; // удалить первую цифру
    n4.Print();
    n4--; // удалить последнюю цифру
    n4.Print();
